...
SpecfunID = fopen('pb.a2f_300kSobol50q_09_woSOC');
data = textscan(SpecfunID,'%f %f %f %f %f %f %f %f %f %f %f %f\n','CommentStyle','#','CollectOutput',true);
BS1 = cell2mat(data);
fclose(SpecfunID);
SpecfunID = fopen('pb.a2f_tr_300kSobol50q_09_woSOC');
data = textscan(SpecfunID,'%f %f %f %f %f %f %f %f %f %f %f %f\n','CommentStyle','#','CollectOutput',true);
BS2 = cell2mat(data);
fclose(SpecfunID);
SpecfunID = fopen('pb.a2f_300kSobol50q_06_wSOC');
data = textscan(SpecfunID,'%f %f %f %f %f %f %f %f %f %f %f %f\n','CommentStyle','#','CollectOutput',true);
BS3 = cell2mat(data);
fclose(SpecfunID);
SpecfunID = fopen('pb.a2f_tr_300kSobol50q_06_wSOC');
data = textscan(SpecfunID,'%f %f %f %f %f %f %f %f %f %f %f %f\n','CommentStyle','#','CollectOutput',true);
BS4 = cell2mat(data);
fclose(SpecfunID);
...
text(9.4,1.45,'\lambda','FontSize',size);
text(9.4,1.85,'\lambda_{tr}','FontSize',size);
